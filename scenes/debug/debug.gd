...
var words : Array[Word] = [
	...
	Word.new("drove", Word.Type.OTHER, 1, Word.Rhyme.OVE, Word.Sounds.d, Word.Vowel.oʊ, Word.Group.VEHICLE),
	...
	Word.new("rather", Word.Type.OTHER, 2, Word.Rhyme.ATHER, Word.Sounds.r, Word.Vowel.ɑː, Word.Group.NONE),
	Word.new("real", Word.Type.OTHER, 1, Word.Rhyme.EAL, Word.Sounds.r, Word.Vowel.iː, Word.Group.ME),
	Word.new("see", Word.Type.OTHER, 1, Word.Rhyme.EE, Word.Sounds.s, Word.Vowel.iː, Word.Group.SENSE),
	Word.new("seem", Word.Type.OTHER, 1, Word.Rhyme.EEM, Word.Sounds.s, Word.Vowel.iː, Word.Group.NONE),
	Word.new("shoes", Word.Type.OTHER, 1, Word.Rhyme.EW, Word.Sounds.ʃ, Word.Vowel.u, Word.Group.STYLE),
	Word.new("smarter", Word.Type.OTHER, 2, Word.Rhyme.ARTER, Word.Sounds.s, Word.Vowel.ɑː, Word.Group.SMARTS),
	Word.new("smell", Word.Type.OTHER, 1, Word.Rhyme.ELL, Word.Sounds.s, Word.Vowel.e, Word.Group.SENSE),
	Word.new("so", Word.Type.OTHER, 1, Word.Rhyme.O, Word.Sounds.s, Word.Vowel.əʊ, Word.Group.NONE),
	Word.new("stupider", Word.Type.OTHER, 3, Word.Rhyme.UPIDER, Word.Sounds.s, Word.Vowel.u, Word.Group.SMARTS),
	Word.new("taking", Word.Type.OTHER, 2, Word.Rhyme.AKING, Word.Sounds.t, Word.Vowel.eɪ, Word.Group.NONE),
	Word.new("than", Word.Type.OTHER, 1, Word.Rhyme.AN, Word.Sounds.ð, Word.Vowel.æ, Word.Group.NONE),
	Word.new("the", Word.Type.OTHER, 1, Word.Rhyme.UH, Word.Sounds.ð, Word.Vowel.ə, Word.Group.NONE),
	Word.new("those", Word.Type.OTHER, 1, Word.Rhyme.OSE, Word.Sounds.ð, Word.Vowel.əʊ, Word.Group.NONE),
	Word.new("you'll", Word.Type.OTHER, 1, Word.Rhyme.ULL, Word.Sounds.j, Word.Vowel.ɔː, Word.Group.YOU),
	Word.new("by", Word.Type.OTHER, 1, Word.Rhyme.HY, Word.Sounds.b, Word.Vowel.aɪ, Word.Group.NONE),
	Word.new("brain", Word.Type.NOUN, 1, Word.Rhyme.AIN, Word.Sounds.b, Word.Vowel.eɪ, Word.Group.SMARTS),
	Word.new("truck", Word.Type.NOUN, 1, Word.Rhyme.UCK, Word.Sounds.t, Word.Vowel.ʌ, Word.Group.VEHICLE),
	Word.new("duck", Word.Type.NOUN, 1, Word.Rhyme.UCK, Word.Sounds.d, Word.Vowel.ʌ, Word.Group.ANIMAL),
	Word.new("brick", Word.Type.NOUN, 1, Word.Rhyme.ICK, Word.Sounds.b, Word.Vowel.ɪ, Word.Group.OBJECT),
	Word.new("fish", Word.Type.NOUN, 1, Word.Rhyme.ISH, Word.Sounds.f, Word.Vowel.ɪ, Word.Group.ANIMAL),
	Word.new("garbage", Word.Type.NOUN, 2, Word.Rhyme.AGE, Word.Sounds.g, Word.Vowel.ɑː, Word.Group.TRASH),
	Word.new("dumpster", Word.Type.NOUN, 2, Word.Rhyme.UMPSTER, Word.Sounds.d, Word.Vowel.ʌ, Word.Group.TRASH),
	Word.new("cheese", Word.Type.NOUN, 1, Word.Rhyme.EESE, Word.Sounds.tʃ, Word.Vowel.iː, Word.Group.FOOD),
	Word.new("L", Word.Type.NOUN, 1, Word.Rhyme.ELL, Word.Sounds.e, Word.Vowel.e, Word.Group.YOU),
	Word.new("you", Word.Type.NOUN, 1, Word.Rhyme.OU, Word.Sounds.j, Word.Vowel.ɔː, Word.Group.YOU),
	Word.new("anyone", Word.Type.NOUN, 2, Word.Rhyme.ONE, Word.Sounds.e, Word.Vowel.iː, Word.Group.PEOPLE),
	Word.new("loser", Word.Type.NOUN, 2, Word.Rhyme.OSER, Word.Sounds.l, Word.Vowel.ɔː, Word.Group.YOU),
	Word.new("winner", Word.Type.NOUN, 2, Word.Rhyme.INNER, Word.Sounds.w, Word.Vowel.ɪ, Word.Group.ME),
	Word.new("dinner", Word.Type.NOUN, 2, Word.Rhyme.INNER, Word.Sounds.d, Word.Vowel.ɪ, Word.Group.FOOD),
	Word.new("chicken", Word.Type.NOUN, 2, Word.Rhyme.ICKEN, Word.Sounds.tʃ, Word.Vowel.ɪ, Word.Group.FOOD),
	Word.new("potato", Word.Type.NOUN, 3, Word.Rhyme.ATO, Word.Sounds.p, Word.Vowel.eɪ, Word.Group.FOOD),
	Word.new("tomato", Word.Type.NOUN, 3, Word.Rhyme.ATO, Word.Sounds.t, Word.Vowel.eɪ, Word.Group.FOOD),
	Word.new("water", Word.Type.NOUN, 2, Word.Rhyme.ATER, Word.Sounds.w, Word.Vowel.ɔː, Word.Group.FOOD),
	Word.new("father", Word.Type.NOUN, 2, Word.Rhyme.ATHER, Word.Sounds.f, Word.Vowel.ɑː, Word.Group.PEOPLE),
	Word.new("mother", Word.Type.NOUN, 2, Word.Rhyme.OTHER, Word.Sounds.m, Word.Vowel.ʌ, Word.Group.PEOPLE),
	Word.new("sister", Word.Type.NOUN, 2, Word.Rhyme.ISTER, Word.Sounds.s, Word.Vowel.ɪ, Word.Group.PEOPLE),
	Word.new("brother", Word.Type.NOUN, 2, Word.Rhyme.OTHER, Word.Sounds.b, Word.Vowel.ʌ, Word.Group.PEOPLE),
	Word.new("fool", Word.Type.NOUN, 1, Word.Rhyme.OOL, Word.Sounds.f, Word.Vowel.uː, Word.Group.YOU),
	Word.new("school", Word.Type.NOUN, 1, Word.Rhyme.OOL, Word.Sounds.s, Word.Vowel.uː, Word.Group.SMARTS),
	Word.new("tool", Word.Type.NOUN, 1, Word.Rhyme.OOL, Word.Sounds.t, Word.Vowel.uː, Word.Group.OBJECT),
	Word.new("bars", Word.Type.NOUN, 1, Word.Rhyme.AR, Word.Sounds.b, Word.Vowel.ɑː, Word.Group.RAP),
	Word.new("cars", Word.Type.NOUN, 1, Word.Rhyme.AR, Word.Sounds.k, Word.Vowel.ɑː, Word.Group.VEHICLE),
	Word.new("flows", Word.Type.NOUN, 1, Word.Rhyme.OW, Word.Sounds.f, Word.Vowel.əʊ, Word.Group.RAP),
	Word.new("lyrics", Word.Type.NOUN, 2, Word.Rhyme.YRIC, Word.Sounds.l, Word.Vowel.ɪ, Word.Group.RAP),
	Word.new("Rhymes", Word.Type.NOUN, 1, Word.Rhyme.YME, Word.Sounds.r, Word.Vowel.ɪ, Word.Group.RAP),
	Word.new("songs", Word.Type.NOUN, 1, Word.Rhyme.ONG, Word.Sounds.s, Word.Vowel.ɒ, Word.Group.RAP),
	Word.new("verses", Word.Type.NOUN, 2, Word.Rhyme.ERSE, Word.Sounds.v, Word.Vowel.ɜː, Word.Group.RAP),
	Word.new("fan", Word.Type.NOUN, 1, Word.Rhyme.AN, Word.Sounds.f, Word.Vowel.æ, Word.Group.PEOPLE),
	Word.new("dog", Word.Type.NOUN, 1, Word.Rhyme.OG, Word.Sounds.d, Word.Vowel.ɑː, Word.Group.ANIMAL),
	Word.new("cat", Word.Type.NOUN, 1, Word.Rhyme.AT, Word.Sounds.k, Word.Vowel.æ, Word.Group.ANIMAL),
	Word.new("rat", Word.Type.NOUN, 1, Word.Rhyme.AT, Word.Sounds.r, Word.Vowel.æ, Word.Group.ANIMAL),
	Word.new("bat", Word.Type.NOUN, 1, Word.Rhyme.AT, Word.Sounds.b, Word.Vowel.æ, Word.Group.ANIMAL),
	...
	Word.new("toaster", Word.Type.NOUN, 2, Word.Rhyme.OASTER, Word.Sounds.t, Word.Vowel.əʊ, Word.Group.FOOD),
	Word.new("blender", Word.Type.NOUN, 2, Word.Rhyme.ENDER, Word.Sounds.b, Word.Vowel.e, Word.Group.FOOD),
	Word.new("microwave", Word.Type.NOUN, 3, Word.Rhyme.AVE, Word.Sounds.m, Word.Vowel.ə, Word.Group.FOOD),
	Word.new("fridge", Word.Type.NOUN, 1, Word.Rhyme.IDGE, Word.Sounds.f, Word.Vowel.ɪ, Word.Group.FOOD),
	Word.new("keyboard", Word.Type.NOUN, 2, Word.Rhyme.OARD, Word.Sounds.k, Word.Vowel.ɔː, Word.Group.RAP),
	Word.new("pen", Word.Type.NOUN, 1, Word.Rhyme.EN, Word.Sounds.p, Word.Vowel.e, Word.Group.RAP),
	Word.new("pencil", Word.Type.NOUN, 1, Word.Rhyme.ENCIL, Word.Sounds.p, Word.Vowel.e, Word.Group.RAP),
	Word.new("plane", Word.Type.NOUN, 1, Word.Rhyme.ANE, Word.Sounds.p, Word.Vowel.eɪ, Word.Group.VEHICLE),
	Word.new("jet", Word.Type.NOUN, 1, Word.Rhyme.ET, Word.Sounds.dʒ, Word.Vowel.e, Word.Group.VEHICLE),
	Word.new("run", Word.Type.VERB, 1, Word.Rhyme.UN, Word.Sounds.r, Word.Vowel.ʌ, Word.Group.ACTION),
	Word.new("walk", Word.Type.VERB, 1, Word.Rhyme.ALK, Word.Sounds.w, Word.Vowel.ɔː, Word.Group.ACTION),
	Word.new("rap", Word.Type.VERB, 1, Word.Rhyme.AP, Word.Sounds.r, Word.Vowel.æ, Word.Group.RAP),
	Word.new("bounce", Word.Type.VERB, 1, Word.Rhyme.OUNCE, Word.Sounds.b, Word.Vowel.aʊ, Word.Group.ACTION),
	Word.new("play", Word.Type.VERB, 1, Word.Rhyme.AYE, Word.Sounds.p, Word.Vowel.eɪ, Word.Group.ACTION),
	Word.new("eat", Word.Type.VERB, 1, Word.Rhyme.EAT, Word.Sounds.iː, Word.Vowel.iː, Word.Group.FOOD),
	Word.new("drink", Word.Type.VERB, 1, Word.Rhyme.INK, Word.Sounds.d, Word.Vowel.ɪ, Word.Group.FOOD),
	Word.new("poop", Word.Type.VERB, 1, Word.Rhyme.OOP, Word.Sounds.p, Word.Vowel.uː, Word.Group.TRASH),
	Word.new("pee", Word.Type.VERB, 1, Word.Rhyme.EE, Word.Sounds.p, Word.Vowel.iː, Word.Group.TRASH),
	Word.new("learn", Word.Type.VERB, 1, Word.Rhyme.EARN, Word.Sounds.l, Word.Vowel.ɜː, Word.Group.SMARTS),
	Word.new("sing", Word.Type.VERB, 1, Word.Rhyme.ING, Word.Sounds.s, Word.Vowel.ɪ, Word.Group.RAP),
	Word.new("write", Word.Type.VERB, 1, Word.Rhyme.ITE, Word.Sounds.w, Word.Vowel.aɪ, Word.Group.RAP),
	Word.new("love", Word.Type.VERB, 1, Word.Rhyme.UVE, Word.Sounds.l, Word.Vowel.ʌ, Word.Group.ME),
	Word.new("hate", Word.Type.VERB, 1, Word.Rhyme.ATE, Word.Sounds.h, Word.Vowel.eɪ, Word.Group.YOU),
	Word.new("trash", Word.Type.VERB, 1, Word.Rhyme.ASH, Word.Sounds.t, Word.Vowel.æ, Word.Group.TRASH),
	Word.new("rapping", Word.Type.VERB, 2, Word.Rhyme.APPING, Word.Sounds.r, Word.Vowel.æ, Word.Group.RAP),
	Word.new("writing", Word.Type.VERB, 2, Word.Rhyme.ITING, Word.Sounds.w, Word.Vowel.aɪ, Word.Group.RAP),
	Word.new("winning", Word.Type.VERB, 2, Word.Rhyme.INNING, Word.Sounds.w, Word.Vowel.ɪ, Word.Group.ME),
	Word.new("losing", Word.Type.VERB, 2, Word.Rhyme.OSING, Word.Sounds.l, Word.Vowel.uː, Word.Group.YOU),
	Word.new("balling", Word.Type.VERB, 2, Word.Rhyme.ALLING, Word.Sounds.b, Word.Vowel.ɔː, Word.Group.ME),
	Word.new("pooping", Word.Type.VERB, 2, Word.Rhyme.OOPING, Word.Sounds.p, Word.Vowel.uː, Word.Group.TRASH),
	Word.new("peeing", Word.Type.VERB, 2, Word.Rhyme.EEING, Word.Sounds.p, Word.Vowel.iː, Word.Group.TRASH),
	Word.new("singing", Word.Type.VERB, 2, Word.Rhyme.INGING, Word.Sounds.s, Word.Vowel.ɪ, Word.Group.RAP),
	Word.new("eating", Word.Type.VERB, 2, Word.Rhyme.EATING, Word.Sounds.iː, Word.Vowel.iː, Word.Group.FOOD),
